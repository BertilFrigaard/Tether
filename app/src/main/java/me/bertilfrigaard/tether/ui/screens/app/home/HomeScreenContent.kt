...
import me.bertilfrigaard.tether.ui.screens.app.home.components.ActionButton
import me.bertilfrigaard.tether.ui.screens.app.home.components.ActionButtonSurface
import me.bertilfrigaard.tether.ui.screens.app.home.components.HomeTopAppBar
import me.bertilfrigaard.tether.ui.theme.TetherTheme

@Composable
fun HomeScreenContent(state: HomeUiState, goToCreateBlock: () -> Unit, goToViewBlocks: () -> Unit, goToSettings: () -> Unit) {
    Scaffold(
        topBar = {
            HomeTopAppBar(goToSettings)
        }
    ) { innerPadding ->
